...
class CommonTest < Test::Unit::TestCase
  ...
  def test_narray_sample_pmf
    ...
    m /= 3
    assert_equal NArray[0, 0, 0], m.sample_pmf_dim(0, NArray[[0.0],[0.0],[0.0]])
    assert_equal NArray[1, 0, 0], m.sample_pmf_dim(0, NArray[[0.4],[0.0],[0.0]])
    assert_equal NArray[1, 2, 0], m.sample_pmf_dim(0, NArray[[0.4],[0.7],[0.0]])
